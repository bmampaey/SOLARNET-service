...
class TestDataSelectionZipIterator(StaticLiveServerTestCase):
	...
	def test_normal_data_selection(self):
		...
		test_data_location1 = self.test_dataset.data_locations.create(
			file_url=self.test_file1_url, file_size=256, file_path='test_path1/file.fits'
		)
		test_data_location2 = self.test_dataset.data_locations.create(
			file_url=self.test_file2_url, file_size=256, file_path='test_path2/file.fits'
		)
	...
	def test_file_offline(self):
		...
		test_data_location1 = self.test_dataset.data_locations.create(
			file_url=self.test_file1_url, file_size=256, file_path='test_path1/file.fits', offline=False
		)
		test_data_location2 = self.test_dataset.data_locations.create(
			file_url=self.test_file2_url, file_size=256, file_path='test_path2/file.fits', offline=True
		)
		self.test_dataset.metadata_model.objects.create(oid='test_metadata1', data_location=test_data_location1)
		self.test_dataset.metadata_model.objects.create(oid='test_metadata2', data_location=test_data_location2)
		test_data_selection = self.test_user.data_selections.create(dataset=self.test_dataset)
	...
	def test_file_max_size(self):
		...
		test_data_location2 = self.test_dataset.data_locations.create(
			file_url=self.test_file2_url, file_size=settings.ZIP_ARCHIVE_MAX_FILE_SIZE + 1, file_path='test_path2/file.fits'
		)
		self.test_dataset.metadata_model.objects.create(oid='test_metadata1', data_location=test_data_location1)
		self.test_dataset.metadata_model.objects.create(oid='test_metadata2', data_location=test_data_location2)
		test_data_selection = self.test_user.data_selections.create(dataset=self.test_dataset)
	...
	def test_total_file_size(self):
		...
		self.test_dataset.metadata_model.objects.create(
			oid='test_metadata1', date_beg=now(), data_location=test_data_location1
		)
		self.test_dataset.metadata_model.objects.create(
			oid='test_metadata2', date_beg=now(), data_location=test_data_location2
		)
	...
	def test_file_not_found(self):
		...
		test_data_location2 = self.test_dataset.data_locations.create(
			file_url=urljoin(self.live_server_url, '/static/does_not_exist.fits'),
			file_size=256,
			file_path='test_path2/file.fits',
		)
		self.test_dataset.metadata_model.objects.create(oid='test_metadata1', data_location=test_data_location1)
		self.test_dataset.metadata_model.objects.create(oid='test_metadata2', data_location=test_data_location2)
		test_data_selection = self.test_user.data_selections.create(dataset=self.test_dataset)
	...
	def test_same_path(self):
		...
		test_data_location = self.test_dataset.data_locations.create(
			file_url=self.test_file1_url, file_size=256, file_path='test_path/file.fits'
		)
