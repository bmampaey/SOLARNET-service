...
class DataSelection(models.Model):
	...
	data_ids = BigIntegerArrayField(help_text = "List of data ids to include or exclude (if all_selected is true)")	item_count = models.IntegerField(help_text="Number of items in the selection", null=True, blank=True)
	created = models.DateTimeField(help_text = "Date of request.", null=False, blank=False, auto_now_add=True)
