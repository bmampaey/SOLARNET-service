	...
	def get_authentication(self, user, password):
		...
		if isinstance(self.resource._meta.authentication, ApiKeyAuthentication):
			...
			raise NotImplementedError(
				'You must override get_authentication for authentication class %s'
				% self.resource._meta.authentication.__class__.__name__
			)
...
class ResourceTestCaseMixin(SvoApiTestCaseMixin):
	...
	def get_test_instance(self):
		...
		if self.test_instance is None:
			raise NotImplementedError(
				'You must override self.test_instance in the setUp method or override the get_test_instance method'
			)
	...
	def test_put_list(self):
		...
		data = {'objects': [self.get_test_post_data()]}
	...
	def test_patch_list(self):
		...
		data = {'objects': [self.get_test_post_data()], 'deleted_objects': [self.get_resource_uri(self.get_test_instance())]}
	...
	def test_post_detail(self):
		...
		response = self.api_client.post(
			self.get_resource_uri(self.get_test_instance()),
			data=data,
			format='json',
