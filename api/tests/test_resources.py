...
class TestUserResource(SvoApiTestCaseMixin, TransactionTestCase):
	...
	def test_get_list(self):
		...
		self.assertDictEqual(self.deserialize(response), {'first_name': self.test_user.first_name, 'last_name': self.test_user.last_name, 'api_key': self.test_user.api_key.key}, msg=msg)
	...
	def test_post_list(self):
		...
		self.assertDictEqual(self.deserialize(response), {'first_name': user.first_name, 'last_name': user.last_name, 'api_key': user.api_key.key}, msg=msg)
