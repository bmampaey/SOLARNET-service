# Generated by Django 3.2.4 on 2022-02-12 09:40
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('metadata', '0008_add_euvi_level_0'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bib_reference', models.TextField(blank=True, help_text='Bibcode or doi preferred; can be URL or anything else', null=True, verbose_name='bib_reference')),
                ...
                ('map_height', models.FloatField(blank=True, help_text='Map size in px', null=True, verbose_name='map_height')),
                ('map_projection', models.TextField(blank=True, help_text='ID from enumerated list, or string with parameters (referring to a standard)', null=True, verbose_name='map_projection')),
                ('map_width', models.FloatField(blank=True, help_text='Map size in px', null=True, verbose_name='map_width')),
                ...
                ('messenger', models.TextField(blank=True, help_text='Electro-magnetic band, from enumerated list', null=True, verbose_name='messenger')),
                ...
                ('producer_institute', models.TextField(blank=True, help_text='Data producer institute', null=True, verbose_name='producer_institute')),
                ('producer_name', models.TextField(blank=True, help_text='Data producer name', null=True, verbose_name='producer_name')),
                ...
                ('data_location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='metadata_eitsynoptic', to='dataset.datalocation')),
                ('tags', models.ManyToManyField(blank=True, related_name='metadata_eitsynoptic', to='metadata.Tag')),
            ],
            options={
