# Generated by Django 3.2.13 on 2026-07-30 11:45
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('metadata', '0040_update_eui_level_1_release7'),
    ]

    operations = [
        migrations.CreateModel(
            name='EuiLevel2Release70',
            fields=[
                ...
                ('att_dist', models.TextField(blank=True, help_text='type of attitude disturbance during exposure', null=True, verbose_name='ATT_DIST')),
                ...
                ('bzero', models.FloatField(blank=True, null=True, verbose_name='BZERO')),
                ...
                ('creator', models.TextField(blank=True, help_text='See HISTORY', null=True, verbose_name='CREATOR')),
                ...
                ('dat50mea', models.FloatField(blank=True, help_text='average pixel value across central 50% image', null=True, verbose_name='DAT50MEA')),
                ('dat50med', models.FloatField(blank=True, help_text='median pixel value across central 50% image', null=True, verbose_name='DAT50MED')),
                ('datamax', models.FloatField(blank=True, help_text='maximum valid physical value', null=True, verbose_name='DATAMAX')),
                ('datamean', models.FloatField(blank=True, help_text='average pixel value across image', null=True, verbose_name='DATAMEAN')),
                ('datamin', models.FloatField(blank=True, help_text='minimum valid physical value', null=True, verbose_name='DATAMIN')),
                ('datap01', models.FloatField(blank=True, help_text='1st percentile pixel value', null=True, verbose_name='DATAP01')),
                ('datap05', models.FloatField(blank=True, help_text='5th percentile pixel value', null=True, verbose_name='DATAP05')),
                ('datap25', models.FloatField(blank=True, help_text='25th percentile pixel value', null=True, verbose_name='DATAP25')),
                ('datap50', models.FloatField(blank=True, help_text='50th percentile pixel value', null=True, verbose_name='DATAP50')),
                ('datap75', models.FloatField(blank=True, help_text='75th percentile pixel value', null=True, verbose_name='DATAP75')),
                ('datap95', models.FloatField(blank=True, help_text='95th percentile pixel value', null=True, verbose_name='DATAP95')),
                ('datap99', models.FloatField(blank=True, help_text='99th percentile pixel value', null=True, verbose_name='DATAP99')),
                ('datapsun', models.FloatField(blank=True, help_text='half solar percentile pixel value', null=True, verbose_name='DATAPSUN')),
                ...
                ('dcrval1', models.FloatField(blank=True, help_text='delta CRVAL1', null=True, verbose_name='DCRVAL1')),
                ('dcrval2', models.FloatField(blank=True, help_text='delta CRVAL2', null=True, verbose_name='DCRVAL2')),
                ...
                ('doorpos', models.BigIntegerField(blank=True, help_text='Door position (raw)', null=True, verbose_name='DOORPOS')),
                ...
                ('filtpos', models.BigIntegerField(blank=True, help_text='filter wheel position service5', null=True, verbose_name='FILTPOS')),
                ('fits_header', models.TextField(blank=True, help_text='Header of HDU 1 in the FITS file', null=True, verbose_name='FITS header')),
                ...
                ('nbin', models.BigIntegerField(blank=True, help_text='total binning factor; NBIN1 x NBIN2', null=True, verbose_name='NBIN')),
                ('nbin1', models.BigIntegerField(blank=True, help_text='on-board binning factor in dim 1', null=True, verbose_name='NBIN1')),
                ('nbin2', models.BigIntegerField(blank=True, help_text='on-board binning factor in dim 2', null=True, verbose_name='NBIN2')),
                ...
                ('rsun_lf', models.FloatField(blank=True, help_text='limb fit Solar radius', null=True, verbose_name='RSUN_LF')),
                ...
                ('soopname', models.TextField(blank=True, help_text='name of the SOOP Campaign', null=True, verbose_name='SOOPNAME')),
                ...
                ('vers_cal', models.TextField(blank=True, help_text='cal version (euiprep git short SHA-1)', null=True, verbose_name='VERS_CAL')),
                ('vers_sw', models.TextField(blank=True, help_text='(L1) version of SW that provided FITS file', null=True, verbose_name='VERS_SW')),
                ('version', models.TextField(blank=True, help_text='incremental version number', null=True, verbose_name='VERSION')),
                ...
                ('data_location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='metadata_euilevel2release70', to='dataset.datalocation')),
                ('tags', models.ManyToManyField(blank=True, related_name='metadata_euilevel2release70', to='metadata.Tag')),
            ],
            options={
