...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('metadata', '0006_add_uset_calciumii_k_level_1'),
    ]

    operations = [
        migrations.CreateModel(
            name='UsetWhiteLightLevel1',
            fields=[
                ...
                ('data_location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='metadata_usetwhitelightlevel1', to='dataset.datalocation')),
                ('tags', models.ManyToManyField(blank=True, related_name='metadata_usetwhitelightlevel1', to='metadata.Tag')),
            ],
            options={
