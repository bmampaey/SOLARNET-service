# Generated by Django 3.2.4 on 2021-10-06 06:54
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('metadata', '0003_add_lyra_level_3'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vers_sw', models.DateTimeField(blank=True, help_text='(L1) version of SW that provided FITS file', null=True, verbose_name='VERS_SW')),
                ...
                ('data_location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='metadata_euilevel2', to='dataset.datalocation')),
                ('tags', models.ManyToManyField(blank=True, related_name='metadata_euilevel2', to='metadata.Tag')),
            ],
            options={
