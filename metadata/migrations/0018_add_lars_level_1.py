# Generated by Django 3.2.13 on 2023-05-05 13:08
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('metadata', '0017_add_chrotel_level_1'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='metadata_larslevel1', to='dataset.datalocation')),
                ('tags', models.ManyToManyField(blank=True, related_name='metadata_larslevel1', to='metadata.Tag')),
            ],
            options={
