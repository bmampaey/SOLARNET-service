...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('metadata', '0039_add_aspiics_level_3'),
    ]

    operations = [
        migrations.CreateModel(
            name='EuiLevel1Release70',
            fields=[
                ...
                ('bscale', models.BigIntegerField(blank=True, null=True, verbose_name='BSCALE')),
                ...
                ('calalgo', models.TextField(blank=True, help_text='calibration algorithm applied on-board (median,', null=True, verbose_name='CALALGO')),
                ('calnum', models.BigIntegerField(blank=True, help_text='number of calibration images', null=True, verbose_name='CALNUM')),
                ...
                ('vers_sw', models.TextField(blank=True, help_text='version of SW that provided FITS file', null=True, verbose_name='VERS_SW')),
                ...
                ('data_location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='metadata_euilevel1release70', to='dataset.datalocation')),
                ('tags', models.ManyToManyField(blank=True, related_name='metadata_euilevel1release70', to='metadata.Tag')),
            ],
            options={
