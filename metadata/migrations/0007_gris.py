# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2017-03-16 11:25
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('metadata', '0006_auto_20170314_1520'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='metadata_gris', to='dataset.DataLocation')),
                ('tags', models.ManyToManyField(blank=True, related_name='metadata_gris', to='metadata.Tag')),
            ],
            options={
                'ordering': ['date_beg'],
                'abstract': False,
