# Generated by Django 3.2.4 on 2022-02-15 18:50
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('metadata', '0009_add_eit_synoptic'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('c1max', models.FloatField(blank=True, help_text='Right Ascension (ICRS), upper limit', null=True, verbose_name='c1max')),
                ('c1min', models.FloatField(blank=True, help_text='Right Ascension (ICRS), lower limit.', null=True, verbose_name='c1min')),
                ...
                ('c2max', models.FloatField(blank=True, help_text='Declination (ICRS), upper limit', null=True, verbose_name='c2max')),
                ('c2min', models.FloatField(blank=True, help_text='Declination (ICRS), lower limit.', null=True, verbose_name='c2min')),
                ...
                ('c3max', models.FloatField(blank=True, help_text='Distance from coordiate origin, upper limit', null=True, verbose_name='c3max')),
                ('c3min', models.FloatField(blank=True, help_text='Distance from coordiate origin, lower limit.', null=True, verbose_name='c3min')),
                ...
                ('datalink_url', models.TextField(blank=True, help_text='Datalinks and services for this objet', null=True, verbose_name='datalink_url')),
                ...
                ('spatial_coordinate_description', models.TextField(blank=True, help_text='ID of specific coordinate system and version / properties', null=True, verbose_name='spatial_coordinate_description')),
                ...
                ('spatial_origin', models.TextField(blank=True, help_text='meta.ref;pos.frame', null=True, verbose_name='spatial_origin')),
                ...
                ('target_distance_max', models.FloatField(blank=True, help_text='Max observer-target distance', null=True, verbose_name='target_distance_max')),
                ('target_distance_min', models.FloatField(blank=True, help_text='Min observer-target distance', null=True, verbose_name='target_distance_min')),
                ...
                ('target_time_max', models.DateTimeField(blank=True, help_text='Max observing time in target frame', null=True, verbose_name='target_time_max')),
                ('target_time_min', models.DateTimeField(blank=True, help_text='Min observing time in target frame', null=True, verbose_name='target_time_min')),
                ...
                ('data_location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='metadata_gaiadem', to='dataset.datalocation')),
                ('tags', models.ManyToManyField(blank=True, related_name='metadata_gaiadem', to='metadata.Tag')),
            ],
            options={
