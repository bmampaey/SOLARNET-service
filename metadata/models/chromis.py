...
class Chromis(BaseMetadata):
	...
	datakurt = models.FloatField('DATAKURT', help_text='The kurtosis (provided value)', blank=True, null=True)
	...
	datamedn = models.FloatField('DATAMEDN', help_text='The median data value (provided value)', blank=True, null=True)
	datamin = models.FloatField('DATAMIN', help_text='The minimum data value (provided value)', blank=True, null=True)
	datap01 = models.FloatField('DATAP01', help_text='The 01 percentile (provided value)', blank=True, null=True)
	datap10 = models.FloatField('DATAP10', help_text='The 10 percentile (provided value)', blank=True, null=True)
	datap25 = models.FloatField('DATAP25', help_text='The 25 percentile (provided value)', blank=True, null=True)
	datap75 = models.FloatField('DATAP75', help_text='The 75 percentile (provided value)', blank=True, null=True)
	datap90 = models.FloatField('DATAP90', help_text='The 90 percentile (provided value)', blank=True, null=True)
	datap95 = models.FloatField('DATAP95', help_text='The 95 percentile (provided value)', blank=True, null=True)
	datap98 = models.FloatField('DATAP98', help_text='The 98 percentile (provided value)', blank=True, null=True)
	datap99 = models.FloatField('DATAP99', help_text='The 99 percentile (provided value)', blank=True, null=True)
	datarms = models.FloatField('DATARMS', help_text='The RMS deviation from the mean (provided value', blank=True, null=True)
	dataskew = models.FloatField('DATASKEW', help_text='The skewness (provided value)', blank=True, null=True)
	date = models.DateTimeField('DATE', help_text='Creation UTC date of FITS header', blank=True, null=True)
	date_avg = models.DateTimeField('DATE-AVG', help_text='Average time of observation (provided value)', blank=True, null=True)
	date_obs = models.DateTimeField('DATE-OBS', help_text='Inferred from directory.', blank=True, null=True)
	dateref = models.DateTimeField('DATEREF', help_text='Reference time in ISO-8601', blank=True, null=True)
	detector = models.TextField('DETECTOR', help_text='Inferred from filename.', blank=True, null=True)
	detfirm = models.TextField('DETFIRM', help_text='', blank=True, null=True)
	detgain = models.FloatField('DETGAIN', help_text='or camera specific unit', blank=True, null=True)
	detmodel = models.TextField('DETMODEL', help_text='', blank=True, null=True)
	detoffs = models.BigIntegerField('DETOFFS', help_text='or camera specific unit', blank=True, null=True)
	...
	extname = models.TextField('EXTNAME', help_text='', blank=True, null=True)
	...
	obs_hdu = models.BigIntegerField('OBS_HDU', help_text='Observational Header and Data Unit', blank=True, null=True)
	...
	prlib2 = models.TextField('PRLIB2', help_text='Software library containing chromis::make_wb_cu', blank=True, null=True)
	...
	prlib3 = models.TextField('PRLIB3', help_text='Software library containing chromis::make_nb_cu', blank=True, null=True)
	...
	prlib4 = models.TextField('PRLIB4', help_text='Software library containing red::fitscube_expor', blank=True, null=True)
	...
	prmode2 = models.TextField('PRMODE2', help_text='Processing mode', blank=True, null=True)
	...
	prpara2 = models.TextField('PRPARA2', help_text='List of parameters/opt', blank=True, null=True)
