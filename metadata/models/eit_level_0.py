...
class EitLevel0(BaseMetadata):
	...
	cmp_no = models.IntegerField(
		verbose_name='CMP_NO', help_text='Unique campaign instance (1 = synoptic) ', blank=True, null=True
	)
	commanded_exposure_time = models.FloatField(
		verbose_name='COMMANDED_EXPOSURE_TIME', help_text='', blank=True, null=True
	)
	...
	exptime = models.FloatField(
		verbose_name='EXPTIME', help_text='Exposure time (total commanded + shutter close)', blank=True, null=True
	)
	...
	sc_roll = models.FloatField(
		verbose_name='SC_ROLL', help_text='s/c roll (Solar north + CCW from nominal)', blank=True, null=True
	)
	sci_obj = models.TextField(verbose_name='SCI_OBJ', help_text='', blank=True, null=True, db_index=True)
	...
	solar_r = models.FloatField(
		verbose_name='SOLAR_R', help_text='Solar photospheric radius, EIT pixels', blank=True, null=True
	)
	telescop = models.TextField(verbose_name='TELESCOP', help_text='', blank=True, null=True)
	wavelnth = models.IntegerField(
		verbose_name='WAVELNTH',
		help_text='Wavelength 284 / 171 = Fe IX/X, 195 = Fe XII, / 284 = Fe XV, 304 = He ',
		blank=True,
		null=True,
		db_index=True,
	)
