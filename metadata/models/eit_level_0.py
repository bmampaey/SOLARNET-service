...
class EitLevel0(BaseMetadata):
	...
	commanded_exposure_time = models.TextField(verbose_name = 'COMMANDED_EXPOSURE_TIME', help_text='', blank=True, null=True)
	...
	shutter_close_time = models.TextField(verbose_name = 'SHUTTER_CLOSE_TIME', help_text='', blank=True, null=True)
