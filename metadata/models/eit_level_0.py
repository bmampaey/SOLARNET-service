...
class EitLevel0(BaseMetadata):
	...
	wavelnth = models.IntegerField(verbose_name = 'WAVELNTH', help_text='Wavelength 284 / 171 = Fe IX/X, 195 = Fe XII, / 284 = Fe XV, 304 = He ', blank=True, null=True, db_index=True)
