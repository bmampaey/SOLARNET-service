...
class AiaLevel2(BaseMetadata):
	...
	aimgshce = models.BigIntegerField(
		verbose_name='AIMGSHCE', help_text='AIA_IMG_SH_CMDED_EXPOSURE', blank=True, null=True
	)
	...
	car_rot = models.BigIntegerField(
	...
	datamax = models.BigIntegerField(
		verbose_name='DATAMAX', help_text='Maximum value of all pixels', blank=True, null=True
	)
	datamean = models.FloatField(verbose_name='DATAMEAN', help_text='Mean value of all pixels', blank=True, null=True)
	datamedn = models.BigIntegerField(
		verbose_name='DATAMEDN', help_text='Median value of all pixels', blank=True, null=True
	)
	datamin = models.BigIntegerField(
		verbose_name='DATAMIN', help_text='Minimum value of all pixels', blank=True, null=True
	)
	...
	datavals = models.BigIntegerField(
	...
	missvals = models.BigIntegerField(
	...
	totvals = models.BigIntegerField(
