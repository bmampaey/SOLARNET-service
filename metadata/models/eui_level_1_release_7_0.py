...
__all__ = ['EuiLevel1Release70']


class EuiLevel1Release70(BaseMetadata):
	"""Model for the metadata of dataset EUI level 1 release 7.0"""

	class Meta(BaseMetadata.Meta):
		verbose_name = 'EUI level 1 release 7.0 metadata'
		verbose_name_plural = 'EUI level 1 release 7.0 metadata'
	...
	badpxdef = models.BigIntegerField(
		verbose_name='BADPXDEF', help_text='commanded bad pixel default', blank=True, null=True
	)
	...
	bscale = models.BigIntegerField(verbose_name='BSCALE', help_text='', blank=True, null=True)
	...
	calalgo = models.TextField(
		verbose_name='CALALGO', help_text='calibration algorithm applied on-board (median,', blank=True, null=True
	)
	calnum = models.BigIntegerField(verbose_name='CALNUM', help_text='number of calibration images', blank=True, null=True)
	...
	comsplvl = models.BigIntegerField(
		verbose_name='COMSPLVL', help_text='WICOM compression splitb3 value', blank=True, null=True
	)
	comstrip = models.TextField(
		verbose_name='COMSTRIP', help_text='compression type: off=whole image; on=strip', blank=True, null=True
	)
	comweimd = models.TextField(
		verbose_name='COMWEIMD', help_text='WICOM compression weighting mode', blank=True, null=True
	)
	...
	crln_obs = models.FloatField(
		verbose_name='CRLN_OBS', help_text='s/c Carrington longitude (L0 angle)', blank=True, null=True
	)
	crlt_obs = models.FloatField(
		verbose_name='CRLT_OBS', help_text='s/c Carrington latitude (B0 angle)', blank=True, null=True
	)
	crota = models.FloatField(verbose_name='CROTA', help_text='rotation angle', blank=True, null=True)
	crpix1 = models.FloatField(
		verbose_name='CRPIX1', help_text='reference pixel location along axis 1', blank=True, null=True
	)
	crpix2 = models.FloatField(
		verbose_name='CRPIX2', help_text='reference pixel location along axis 2', blank=True, null=True
	)
	...
	crval1 = models.FloatField(
		verbose_name='CRVAL1', help_text='value of reference pixel along axis 1', blank=True, null=True
	)
	crval2 = models.FloatField(
		verbose_name='CRVAL2', help_text='value of reference pixel along axis 2', blank=True, null=True
	)
	ctype1 = models.TextField(
		verbose_name='CTYPE1', help_text='helioprojective longitude (Solar X)', blank=True, null=True
	)
	...
	datamean = models.FloatField(
		verbose_name='DATAMEAN', help_text='average pixel value across the image', blank=True, null=True
	)
	...
	date_ear = models.DateTimeField(
		verbose_name='DATE_EAR', help_text='start time of observation Earth', blank=True, null=True
	)
	date_obs = models.DateTimeField(
		verbose_name='DATE-OBS', help_text='deprecated, same as DATE-BEG.', blank=True, null=True
	)
	...
	detreg27 = models.BigIntegerField(
		verbose_name='DETREG27', help_text='REG27_IDAC_CDSSTAGE1_COMPA', blank=True, null=True
	)
	detreg28 = models.BigIntegerField(
		verbose_name='DETREG28', help_text='REG28_IDAC_INVBUFFER_REFBU', blank=True, null=True
	)
	detreg29 = models.BigIntegerField(
		verbose_name='DETREG29', help_text='REG29_IDAC_COLBUFFER_COLBU', blank=True, null=True
	)
	detreg2a = models.BigIntegerField(
		verbose_name='DETREG2A', help_text='REG2A_IDAC_COLPC_COLGAINST', blank=True, null=True
	)
	detreg2b = models.BigIntegerField(
		verbose_name='DETREG2B', help_text='REG2B_IDAC_OUTPUTDRIVER_CO', blank=True, null=True
	)
	detreg2c = models.BigIntegerField(verbose_name='DETREG2C', help_text='REG2C_VDAC_BLACKSUN_EVEN', blank=True, null=True)
	detreg2d = models.BigIntegerField(
		verbose_name='DETREG2D', help_text='REG2D_IDAC_ABS_REBUFF_TEMP', blank=True, null=True
	)
	detreg2e = models.BigIntegerField(
		verbose_name='DETREG2E', help_text='REG2E_COLGAIN_EVEN_FF_MID', blank=True, null=True
	)
	detreg2f = models.BigIntegerField(
		verbose_name='DETREG2F', help_text='REG2F_COLGAIN_EVEN_FF_LOW', blank=True, null=True
	)
	detreg30 = models.BigIntegerField(
		verbose_name='DETREG30', help_text='REG30_COLGAIN_EVEN_FB_MID', blank=True, null=True
	)
	detreg31 = models.BigIntegerField(
		verbose_name='DETREG31', help_text='REG31_COLGAIN_EVEN_FB_LOW', blank=True, null=True
	)
	detreg32 = models.BigIntegerField(
		verbose_name='DETREG32', help_text='REG32_COLGAIN_EVEN_FB_HIGH', blank=True, null=True
	)
	...
	detreg37 = models.BigIntegerField(
		verbose_name='DETREG37', help_text='REG37_COLGAIN_VDAC_SIGCLAM', blank=True, null=True
	)
	detreg38 = models.BigIntegerField(
		verbose_name='DETREG38', help_text='REG38_CDS_EN_SAMPLE_CLOCK_', blank=True, null=True
	)
	detreg39 = models.BigIntegerField(
		verbose_name='DETREG39', help_text='REG39_MBS_PIXCOL_ADDR_LOW', blank=True, null=True
	)
	detreg3a = models.BigIntegerField(
		verbose_name='DETREG3A', help_text='REG3A_MBS_PIXCOL_ADDR_HIGH', blank=True, null=True
	)
	detreg3b = models.BigIntegerField(
		verbose_name='DETREG3B', help_text='REG3B_MBS_MUXBUS_SR_EOSX_S', blank=True, null=True
	)
	detreg3c = models.BigIntegerField(
		verbose_name='DETREG3C', help_text='REG3C_VDAC_SIGC_LAMP_BLACK', blank=True, null=True
	)
	...
	downloam = models.BigIntegerField(
		verbose_name='DOWNLOAM', help_text='commanded FEE download mode', blank=True, null=True
	)
	...
	ear_tdel = models.FloatField(
		verbose_name='EAR_TDEL', help_text='Time(Sun to Earth) - Time(Sun to S/C)', blank=True, null=True
	)
	euxcen = models.FloatField(
		verbose_name='EUXCEN', help_text='axis 1 location of solar center in L1', blank=True, null=True
	)
	euycen = models.FloatField(
		verbose_name='EUYCEN', help_text='axis 2 location of solar center in L1', blank=True, null=True
	)
	filcpos = models.BigIntegerField(
		verbose_name='FILCPOS', help_text='filter wheel commanded position', blank=True, null=True
	)
	...
	gainthre = models.BigIntegerField(
		verbose_name='GAINTHRE', help_text='commanded threshold value for H/L gain', blank=True, null=True
	)
	...
	haex_obs = models.FloatField(
		verbose_name='HAEX_OBS', help_text='s/c Heliocentric Aries Ecliptic X', blank=True, null=True
	)
	haey_obs = models.FloatField(
		verbose_name='HAEY_OBS', help_text='s/c Heliocentric Aries Ecliptic Y', blank=True, null=True
	)
	haez_obs = models.FloatField(
		verbose_name='HAEZ_OBS', help_text='s/c Heliocentric Aries Ecliptic Z', blank=True, null=True
	)
	hcix_obs = models.FloatField(verbose_name='HCIX_OBS', help_text='s/c Heliocentric Inertial X', blank=True, null=True)
	hcix_vob = models.FloatField(
		verbose_name='HCIX_VOB', help_text='s/c Heliocentric Inertial X Velocity', blank=True, null=True
	)
	hciy_obs = models.FloatField(verbose_name='HCIY_OBS', help_text='s/c Heliocentric Inertial Y', blank=True, null=True)
	hciy_vob = models.FloatField(
		verbose_name='HCIY_VOB', help_text='s/c Heliocentric Inertial Y Velocity', blank=True, null=True
	)
	hciz_obs = models.FloatField(verbose_name='HCIZ_OBS', help_text='s/c Heliocentric Inertial Z', blank=True, null=True)
	hciz_vob = models.FloatField(
		verbose_name='HCIZ_VOB', help_text='s/c Heliocentric Inertial Z Velocity', blank=True, null=True
	)
	...
	heqx_obs = models.FloatField(
		verbose_name='HEQX_OBS', help_text='s/c Heliocentric Earth Equatorial X', blank=True, null=True
	)
	heqy_obs = models.FloatField(
		verbose_name='HEQY_OBS', help_text='s/c Heliocentric Earth Equatorial Y', blank=True, null=True
	)
	heqz_obs = models.FloatField(
		verbose_name='HEQZ_OBS', help_text='s/c Heliocentric Earth Equatorial Z', blank=True, null=True
	)
	...
	ledstate = models.TextField(
		verbose_name='LEDSTATE', help_text='LED control for current telescope', blank=True, null=True
	)
	...
	obs_vr = models.FloatField(
		verbose_name='OBS_VR', help_text='Radial velocity of S/C relative to Sun', blank=True, null=True
	)
	...
	offsethg = models.BigIntegerField(
		verbose_name='OFFSETHG', help_text='global offset corr. high gain', blank=True, null=True
	)
	offsetlg = models.BigIntegerField(
		verbose_name='OFFSETLG', help_text='global offset corr. low gain', blank=True, null=True
	)
	...
	pc1_1 = models.FloatField(
		verbose_name='PC1_1', help_text='WCS coordinate transformation matrix', blank=True, null=True
	)
	pc1_2 = models.FloatField(
		verbose_name='PC1_2', help_text='WCS coordinate transformation matrix', blank=True, null=True
	)
	pc2_1 = models.FloatField(
		verbose_name='PC2_1', help_text='WCS coordinate transformation matrix', blank=True, null=True
	)
	...
	pxbeg1 = models.BigIntegerField(
		verbose_name='PXBEG1', help_text='first read-out pixel in dimension 1', blank=True, null=True
	)
	pxbeg2 = models.BigIntegerField(
		verbose_name='PXBEG2', help_text='first read-out pixel in dimension 2', blank=True, null=True
	)
	pxend1 = models.BigIntegerField(
		verbose_name='PXEND1', help_text='last read-out pixel in dimension 1', blank=True, null=True
	)
	pxend2 = models.BigIntegerField(
		verbose_name='PXEND2', help_text='last read-out pixel in dimension 2', blank=True, null=True
	)
	readoutm = models.BigIntegerField(
		verbose_name='READOUTM', help_text='commanded FEE readout mode', blank=True, null=True
	)
	rechigh = models.BigIntegerField(
		verbose_name='RECHIGH', help_text='rec. threshold high(clipped 2^RECNRBIT-1)', blank=True, null=True
	)
	reclow = models.BigIntegerField(
		verbose_name='RECLOW', help_text='rec. threshold low (clipped 0)', blank=True, null=True
	)
	recnrbit = models.BigIntegerField(
		verbose_name='RECNRBIT', help_text='bit depth recoding output (sqrt)', blank=True, null=True
	)
	...
	rsun_ref = models.BigIntegerField(
		verbose_name='RSUN_REF', help_text='assumed physical solar radius', blank=True, null=True
	)
	scitabid = models.BigIntegerField(
		verbose_name='SCITABID', help_text='exposure identifier in sec. science table', blank=True, null=True
	)
	scitabnr = models.BigIntegerField(
		verbose_name='SCITABNR', help_text='sequential number of SCITABID', blank=True, null=True
	)
	...
	temp1det = models.FloatField(
		verbose_name='TEMP1DET', help_text='last measured APS det. T before date-avg', blank=True, null=True
	)
	temp2det = models.FloatField(
		verbose_name='TEMP2DET', help_text='earliest measured APS det. T after date-avg', blank=True, null=True
	)
	tempint = models.FloatField(
		verbose_name='TEMPINT', help_text='internal APS detector temperature', blank=True, null=True
	)
	...
	vers_sw = models.TextField(
		verbose_name='VERS_SW', help_text='version of SW that provided FITS file', blank=True, null=True
	)
