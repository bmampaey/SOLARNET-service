...
__all__ = ['EuiLevel2Release70']


class EuiLevel2Release70(BaseMetadata):
	"""Model for the metadata of dataset EUI level 2 release 7.0"""

	class Meta(BaseMetadata.Meta):
		verbose_name = 'EUI level 2 release 7.0 metadata'
		verbose_name_plural = 'EUI level 2 release 7.0 metadata'
	...
	vers_cal = models.TextField(
		verbose_name='VERS_CAL', help_text='cal version (euiprep git short SHA-1)', blank=True, null=True
	)
	vers_sw = models.TextField(
		verbose_name='VERS_SW', help_text='(L1) version of SW that provided FITS file', blank=True, null=True
	)
