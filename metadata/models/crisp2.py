...
class Crisp2(BaseMetadata):
	...
	datakurt = models.FloatField(verbose_name = 'DATAKURT', help_text='The excess kurtosis of the data (provided value', blank=True, null=True)
	...
	datamedn = models.FloatField(verbose_name = 'DATAMEDN', help_text='The 50 percentile of the data (provided value)', blank=True, null=True)
	datamin = models.FloatField(verbose_name = 'DATAMIN', help_text='The minimum data value (provided value)', blank=True, null=True)
	datap01 = models.FloatField(verbose_name = 'DATAP01', help_text='The 01 percentile of the data (provided value)', blank=True, null=True)
	datap10 = models.FloatField(verbose_name = 'DATAP10', help_text='The 10 percentile of the data (provided value)', blank=True, null=True)
	datap25 = models.FloatField(verbose_name = 'DATAP25', help_text='The 25 percentile of the data (provided value)', blank=True, null=True)
	datap75 = models.FloatField(verbose_name = 'DATAP75', help_text='The 75 percentile of the data (provided value)', blank=True, null=True)
	datap90 = models.FloatField(verbose_name = 'DATAP90', help_text='The 90 percentile of the data (provided value)', blank=True, null=True)
	datap95 = models.FloatField(verbose_name = 'DATAP95', help_text='The 95 percentile of the data (provided value)', blank=True, null=True)
	datap98 = models.FloatField(verbose_name = 'DATAP98', help_text='The 98 percentile of the data (provided value)', blank=True, null=True)
	datap99 = models.FloatField(verbose_name = 'DATAP99', help_text='The 99 percentile of the data (provided value)', blank=True, null=True)
	...
	dataskew = models.FloatField(verbose_name = 'DATASKEW', help_text='The skewness of the data (provided value)', blank=True, null=True)
	date = models.TextField(verbose_name = 'DATE', help_text='Creation UTC date of FITS header', blank=True, null=True)
	date_avg = models.DateTimeField(verbose_name = 'DATE-AVG', help_text='Average time of observation (provided va', blank=True, null=True)
	...
	npixels = models.BigIntegerField(verbose_name = 'NPIXELS', help_text='Number of pixels (provided value)', blank=True, null=True)
	...
	prlib2 = models.TextField(verbose_name = 'PRLIB2', help_text='Software library containing red::make_wb_cube', blank=True, null=True)
	...
	prlib3 = models.TextField(verbose_name = 'PRLIB3', help_text='Software library containing crisp::demodulate', blank=True, null=True)
	...
	prlib4 = models.TextField(verbose_name = 'PRLIB4', help_text='Software library containing crisp::make_nb_cube', blank=True, null=True)
	...
	prlib5 = models.TextField(verbose_name = 'PRLIB5', help_text='Software library containing red::fitscube_cross', blank=True, null=True)
	...
	prlib6 = models.TextField(verbose_name = 'PRLIB6', help_text='Software library containing red::fitscube_expor', blank=True, null=True)
	...
	prpara6 = models.TextField(verbose_name = 'PRPARA6', help_text='List of parameters/options for PRPROC6', blank=True, null=True)
	...
	prver5a = models.TextField(verbose_name = 'PRVER5A', help_text='Library version/MJD of last update', blank=True, null=True)
	prver5b = models.TextField(verbose_name = 'PRVER5B', help_text='Library version/MJD of last update', blank=True, null=True)
	prver5c = models.TextField(verbose_name = 'PRVER5C', help_text='Library version/MJD of last update', blank=True, null=True)
	prver5d = models.TextField(verbose_name = 'PRVER5D', help_text='Library version/MJD of last update', blank=True, null=True)
	prver6 = models.TextField(verbose_name = 'PRVER6', help_text='Library version/MJD of last update', blank=True, null=True)
	prver6a = models.TextField(verbose_name = 'PRVER6A', help_text='Library version/MJD of last update', blank=True, null=True)
	prver6b = models.TextField(verbose_name = 'PRVER6B', help_text='Library version/MJD of last update', blank=True, null=True)
	prver6c = models.TextField(verbose_name = 'PRVER6C', help_text='Library version/MJD of last update', blank=True, null=True)
	prver6d = models.TextField(verbose_name = 'PRVER6D', help_text='Library version/MJD of last update', blank=True, null=True)
