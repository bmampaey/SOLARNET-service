...
class HmiMagnetogramLevel15(BaseMetadata):
	...
	cal_fsn = models.BigIntegerField(verbose_name = 'CAL_FSN', help_text='FSN of the look-up table used to produce the observables', blank=True, null=True)
	calver64 = models.BigIntegerField(verbose_name = 'CALVER64', help_text='Calibration Version', blank=True, null=True)
	camera = models.BigIntegerField(verbose_name = 'CAMERA', help_text='For HMI: 1 (side camera), 2 (front camera), or 3 (both cameras)', blank=True, null=True)
	...
	datasign = models.BigIntegerField(verbose_name = 'DATASIGN', help_text='DATASIGN: sign of observable quantity wrt Sun center', blank=True, null=True)
	...
	datavals = models.BigIntegerField(verbose_name = 'DATAVALS', help_text='Actual number of data values in images (pixels)', blank=True, null=True)
	...
	odicoeff = models.BigIntegerField(verbose_name = 'ODICOEFF', help_text='order of the distortion-coefficient polynomials', blank=True, null=True)
	origin = models.TextField(verbose_name = 'ORIGIN', help_text='ORIGIN: location where file made', blank=True, null=True)
	orocoeff = models.BigIntegerField(verbose_name = 'OROCOEFF', help_text='order of the differential-rotation polynomials', blank=True, null=True)
	polcalm = models.BigIntegerField(verbose_name = 'POLCALM', help_text='method used by the polarization calibration subroutine', blank=True, null=True)
	qlook = models.BigIntegerField(verbose_name = 'QLOOK', help_text='QLOOK: 0=final data, 1=quick-look data', blank=True, null=True)
	quality = models.BigIntegerField(verbose_name = 'QUALITY', help_text='Level 1.5 Quality word', blank=True, null=True)
	quallev1 = models.BigIntegerField(verbose_name = 'QUALLEV1', help_text='Logical OR on the bits of the level 1 Quality word', blank=True, null=True)
	...
	sintnum = models.BigIntegerField(verbose_name = 'SINTNUM', help_text='number of points used for the spatial interpolation', blank=True, null=True)
	...
	tintnum = models.BigIntegerField(verbose_name = 'TINTNUM', help_text='number of points used for the temporal interpolation', blank=True, null=True)
