...
class AiaLevel1(BaseMetadata):
	...
	acs_cgt = models.TextField(
		verbose_name='ACS_CGT', help_text='ACS ID of Controlling Guide Telescope - ACS_AN_NUM_CGT', blank=True, null=True
	)
	acs_eclp = models.TextField(
		verbose_name='ACS_ECLP', help_text='ACS eclipse flag - ACS_AN_FLAG_CSS_ECLIPSE', blank=True, null=True
	)
	acs_mode = models.TextField(
		verbose_name='ACS_MODE', help_text='ACS pointing mode - ACS_AN_ACS_MODE', blank=True, null=True
	)
	acs_safe = models.TextField(
		verbose_name='ACS_SAFE', help_text='ACS safe hold flag - ACS_AN_FLAG_ACE_INSAFEHOLD', blank=True, null=True
	)
	acs_sunp = models.TextField(
		verbose_name='ACS_SUNP', help_text='ACS sun presense flag - ACS_AN_FLAG_DSS_SUNPRES', blank=True, null=True
	)
	...
	asd_rec = models.TextField(
		verbose_name='ASD_REC', help_text='Ancillary Science Data series record pointer', blank=True, null=True
	)
	...
	bld_vers = models.TextField(
		verbose_name='BLD_VERS', help_text='Build Version: from jsoc_version.h', blank=True, null=True
	)
	camera = models.IntegerField(verbose_name='CAMERA', help_text='For AIA: 1, 2, 3  or 4', blank=True, null=True)
	car_rot = models.IntegerField(
		verbose_name='CAR_ROT', help_text='Carrington rotation number of CRLN_OBS', blank=True, null=True
	)
	cdelt1 = models.FloatField(
		verbose_name='CDELT1', help_text='CDELT1: image scale in the x direction', blank=True, null=True
	)
	cdelt2 = models.FloatField(
		verbose_name='CDELT2', help_text='CDELT2: image scale in the y direction', blank=True, null=True
	)
	crln_obs = models.FloatField(
		verbose_name='CRLN_OBS', help_text='Carrington longitude of the observer', blank=True, null=True
	)
	crlt_obs = models.FloatField(
		verbose_name='CRLT_OBS', help_text='Carrington latitude of the observer', blank=True, null=True
	)
	...
	crpix1 = models.FloatField(
		verbose_name='CRPIX1', help_text='CRPIX1: location of sun center in CCD x direction', blank=True, null=True
	)
	crpix2 = models.FloatField(
		verbose_name='CRPIX2', help_text='CRPIX2: location of sun center in CCD y direction', blank=True, null=True
	)
	crval1 = models.FloatField(
		verbose_name='CRVAL1', help_text='CRVAL1: image scale in the x direction', blank=True, null=True
	)
	crval2 = models.FloatField(
		verbose_name='CRVAL2', help_text='CRVAL2: image scale in the x direction', blank=True, null=True
	)
	ctype1 = models.TextField(
		verbose_name='CTYPE1', help_text='CTYPE1; Typically HPLN-TAN (SOLARX)', blank=True, null=True
	)
	ctype2 = models.TextField(
		verbose_name='CTYPE2', help_text='CTYPE2; Typically HPLT-TAN (SOLARY)', blank=True, null=True
	)
	...
	datacent = models.FloatField(
		verbose_name='DATACENT', help_text='Median value of center column of the image', blank=True, null=True
	)
	...
	datarms = models.FloatField(
		verbose_name='DATARMS', help_text='Rms deviation from the mean value of all pixels', blank=True, null=True
	)
	dataskew = models.FloatField(
		verbose_name='DATASKEW', help_text='Skewness from the mean value of all pixels', blank=True, null=True
	)
	datavals = models.IntegerField(
		verbose_name='DATAVALS', help_text='Actual number of data values in image', blank=True, null=True
	)
	...
	date_obs = models.DateTimeField(
		verbose_name='DATE-OBS', help_text=' Date when observation started; ISO 8601', blank=True, null=True
	)
	dn_gain = models.FloatField(verbose_name='DN_GAIN', help_text='DN/electron', blank=True, null=True)
	dsun_obs = models.FloatField(
		verbose_name='DSUN_OBS', help_text='Distance from SDO to Sun center', blank=True, null=True
	)
	dsun_ref = models.FloatField(
		verbose_name='DSUN_REF', help_text='Reference distance to Sun: 149,597,870,691.0 m', blank=True, null=True
	)
	eff_ar_v = models.FloatField(
		verbose_name='EFF_AR_V', help_text='version # for EFF_AREA and DN_GAIN', blank=True, null=True
	)
	...
	exptime = models.FloatField(
		verbose_name='EXPTIME', help_text='Exposure duration: mean shutter open time', blank=True, null=True
	)
	fid = models.IntegerField(verbose_name='FID', help_text='FID Filtergram ID', blank=True, null=True)
	flat_rec = models.TextField(
		verbose_name='FLAT_REC', help_text='Flatfield series record pointer', blank=True, null=True
	)
	fsn = models.IntegerField(verbose_name='FSN', help_text='FSN Filtergram Sequence Number', blank=True, null=True)
	gaex_obs = models.FloatField(
		verbose_name='GAEX_OBS', help_text='Geocentric Inertial X position', blank=True, null=True
	)
	gaey_obs = models.FloatField(
		verbose_name='GAEY_OBS', help_text='Geocentric Inertial Y position', blank=True, null=True
	)
	gaez_obs = models.FloatField(
		verbose_name='GAEZ_OBS', help_text='Geocentric Inertial Z position', blank=True, null=True
	)
	haex_obs = models.FloatField(
		verbose_name='HAEX_OBS', help_text='Heliocentric Inertial X position', blank=True, null=True
	)
	haey_obs = models.FloatField(
		verbose_name='HAEY_OBS', help_text='Heliocentric Inertial Y position', blank=True, null=True
	)
	haez_obs = models.FloatField(
		verbose_name='HAEZ_OBS', help_text='Heliocentric Inertial Z position', blank=True, null=True
	)
	hgln_obs = models.FloatField(
		verbose_name='HGLN_OBS', help_text='Stonyhurst heliographic longitude of the observer', blank=True, null=True
	)
	hglt_obs = models.FloatField(
		verbose_name='HGLT_OBS', help_text='Stonyhurst heliographic latitude of the observer', blank=True, null=True
	)
	...
	inst_rot = models.FloatField(
		verbose_name='INST_ROT', help_text='Master pointing CCD rotation wrt SDO Z axis', blank=True, null=True
	)
	instrume = models.TextField(
		verbose_name='INSTRUME', help_text='For AIA: AIA_ATA1, AIA_ATA2, AIA_ATA3 or AIA_ATA4', blank=True, null=True
	)
	int_time = models.FloatField(verbose_name='INT_TIME', help_text='CCD integration duration', blank=True, null=True)
	isppktim = models.DateTimeField(
		verbose_name='ISPPKTIM', help_text='PACKET_TIME, Prime key value for the ISP record', blank=True, null=True
	)
	...
	missvals = models.IntegerField(
		verbose_name='MISSVALS', help_text='Missing values: TOTVALS - DATAVALS', blank=True, null=True
	)
	mpo_rec = models.TextField(
		verbose_name='MPO_REC', help_text='Master Pointing series record pointer', blank=True, null=True
	)
	nsatpix = models.IntegerField(
		verbose_name='NSATPIX', help_text='Number of saturated pixels detected in image', blank=True, null=True
	)
	nspikes = models.IntegerField(
		verbose_name='NSPIKES', help_text='Number of cosmic ray affected pixels detected in image', blank=True, null=True
	)
	obs_vn = models.FloatField(
		verbose_name='OBS_VN', help_text='Speed of observer in solar-north direction', blank=True, null=True
	)
	obs_vr = models.FloatField(
		verbose_name='OBS_VR', help_text='Speed of observer in radial direction', blank=True, null=True
	)
	obs_vw = models.FloatField(
		verbose_name='OBS_VW', help_text='Speed of observer in solar-west direction', blank=True, null=True
	)
	orb_rec = models.TextField(
		verbose_name='ORB_REC', help_text='Orbit vector series record pointer', blank=True, null=True
	)
	...
	oscnrms = models.FloatField(
		verbose_name='OSCNRMS', help_text='Rms deviation from the mean value of overscan rows', blank=True, null=True
	)
	percentd = models.FloatField(
		verbose_name='PERCENTD', help_text='Percent data; 100*DATAVALS/TOTVALS', blank=True, null=True
	)
	...
	r_sun = models.FloatField(
		verbose_name='R_SUN', help_text='Radius of the Sun in pixels on the CCD detector', blank=True, null=True
	)
	recnum = models.BigIntegerField(verbose_name='RECNUM', help_text='JSOC Record Number', blank=True, null=True)
	roi_llx1 = models.IntegerField(
		verbose_name='ROI_LLX1', help_text='CCD X location of lower left corner of ROI1', blank=True, null=True
	)
	roi_llx2 = models.IntegerField(
		verbose_name='ROI_LLX2', help_text='CCD X location of lower left corner of ROI2', blank=True, null=True
	)
	roi_lly1 = models.IntegerField(
		verbose_name='ROI_LLY1', help_text='CCD Y location of lower left corner of ROI1', blank=True, null=True
	)
	roi_lly2 = models.IntegerField(
		verbose_name='ROI_LLY2', help_text='CCD Y location of lower left corner of ROI2', blank=True, null=True
	)
	roi_nax1 = models.IntegerField(
		verbose_name='ROI_NAX1', help_text='Number of CCD columns for width of ROI1', blank=True, null=True
	)
	roi_nax2 = models.IntegerField(
		verbose_name='ROI_NAX2', help_text='Number of CCD columns for width of ROI2', blank=True, null=True
	)
	roi_nay1 = models.IntegerField(
		verbose_name='ROI_NAY1', help_text='Number of CCD rows for height of ROI1', blank=True, null=True
	)
	roi_nay2 = models.IntegerField(
		verbose_name='ROI_NAY2', help_text='Number of CCD rows for height of ROI2', blank=True, null=True
	)
	roi_nwin = models.IntegerField(
		verbose_name='ROI_NWIN', help_text='Number of Windows for Region of Interest (ROI)', blank=True, null=True
	)
	roi_sum = models.IntegerField(
		verbose_name='ROI_SUM', help_text='Summing Mode: 1x1, 2x2, 4x4 (0,1,2)', blank=True, null=True
	)
	rsun_obs = models.FloatField(
		verbose_name='RSUN_OBS', help_text='Apparent radius of the Sun seen by SDO', blank=True, null=True
	)
	rsun_ref = models.FloatField(
		verbose_name='RSUN_REF', help_text='Reference radius of the Sun: 696,000,000.0 m', blank=True, null=True
	)
	sat_rot = models.FloatField(
		verbose_name='SAT_ROT', help_text='Angle of solar pole wrt the SDO X axis', blank=True, null=True
	)
	sat_y0 = models.FloatField(
		verbose_name='SAT_Y0', help_text='Position of solar center wrt the SDO -Y axis', blank=True, null=True
	)
	sat_z0 = models.FloatField(
		verbose_name='SAT_Z0', help_text='Position of solar center wrt the SDO Z axis', blank=True, null=True
	)
	...
	tempfpad = models.FloatField(
		verbose_name='TEMPFPAD', help_text='Focal plane assembly adapter temperature: FPA_ADAPTER', blank=True, null=True
	)
	tempgt = models.FloatField(verbose_name='TEMPGT', help_text='Guide telescope temperature: GT_1', blank=True, null=True)
	tempsmir = models.FloatField(
		verbose_name='TEMPSMIR', help_text='Secondary mirror temperature : SEC_MIRROR', blank=True, null=True
	)
	totvals = models.IntegerField(
		verbose_name='TOTVALS', help_text='Expected number of data values (pixels)', blank=True, null=True
	)
	...
	x0_mp = models.FloatField(
		verbose_name='X0_MP', help_text='Master pointing X0 sun center in CCD frame', blank=True, null=True
	)
	y0_mp = models.FloatField(
		verbose_name='Y0_MP', help_text='Master pointing Y0 sun center in CCD frame', blank=True, null=True
	)
