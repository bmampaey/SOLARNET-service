...
class GaiaDem(BaseMetadata):
	...
	c1min = models.FloatField(verbose_name = 'c1min', help_text='Right Ascension (ICRS), lower limit.', blank=True, null=True)
	...
	c3max = models.FloatField(verbose_name = 'c3max', help_text='Distance from coordiate origin, upper limit', blank=True, null=True)
	c3min = models.FloatField(verbose_name = 'c3min', help_text='Distance from coordiate origin, lower limit.', blank=True, null=True)
	...
	datalink_url = models.TextField(verbose_name = 'datalink_url', help_text='Datalinks and services for this objet', blank=True, null=True)
	...
	spatial_coordinate_description = models.TextField(verbose_name = 'spatial_coordinate_description', help_text='ID of specific coordinate system and version / properties', blank=True, null=True)
	...
	target_distance_max = models.FloatField(verbose_name = 'target_distance_max', help_text='Max observer-target distance', blank=True, null=True)
	target_distance_min = models.FloatField(verbose_name = 'target_distance_min', help_text='Min observer-target distance', blank=True, null=True)
	...
	target_time_max = models.DateTimeField(verbose_name = 'target_time_max', help_text='Max observing time in target frame', blank=True, null=True)
	target_time_min = models.DateTimeField(verbose_name = 'target_time_min', help_text='Min observing time in target frame', blank=True, null=True)
