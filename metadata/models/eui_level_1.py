...
class EuiLevel1(BaseMetadata):
	...
	blank = models.BigIntegerField(verbose_name = 'BLANK', help_text='value undefined pixels before BSCALE,BZERO', blank=True, null=True)
	bscale = models.BigIntegerField(verbose_name = 'BSCALE', help_text='ratio of physical to array value at 0 offset', blank=True, null=True)
	...
	bzero = models.BigIntegerField(verbose_name = 'BZERO', help_text='physical value for the array value 0', blank=True, null=True)
	...
	datamax = models.BigIntegerField(verbose_name = 'DATAMAX', help_text='maximum valid physical value', blank=True, null=True)
	datamean = models.FloatField(verbose_name = 'DATAMEAN', help_text='average pixel value across the image', blank=True, null=True)
	datamin = models.BigIntegerField(verbose_name = 'DATAMIN', help_text='minimum valid physical value', blank=True, null=True)
	...
	doorpos = models.BigIntegerField(verbose_name = 'DOORPOS', help_text='Door position (raw) = open', blank=True, null=True)
	...
	extend = models.BooleanField(verbose_name = 'EXTEND', help_text='F = no extensions T = extension(s)', blank=True, null=True)
	...
	filtpos = models.BigIntegerField(verbose_name = 'FILTPOS', help_text='(0-199) filter wheel position determ. from tm5', blank=True, null=True)
	...
	vers_sw = models.DateTimeField(verbose_name = 'VERS_SW', help_text='version of SW that provided FITS file', blank=True, null=True)
	version = models.DateTimeField(verbose_name = 'VERSION', help_text='incremental version number', blank=True, null=True)
	wavelnth = models.BigIntegerField(verbose_name = 'WAVELNTH', help_text='characteristic wavelength of observation', blank=True, null=True)
