...
class EuiLevel1(BaseMetadata):
	...
	compress = models.TextField(verbose_name = 'COMPRESS', help_text='data compression quality (None/Lossless/Lossy)', blank=True, null=True, db_index=True)
	...
	detector = models.TextField(verbose_name = 'DETECTOR', help_text='instrument subunit or sensor', blank=True, null=True, db_index=True)
	...
	vers_sw = models.TextField(verbose_name = 'VERS_SW', help_text='version of SW that provided FITS file', blank=True, null=True)
	version = models.TextField(verbose_name = 'VERSION', help_text='incremental version number', blank=True, null=True)
	wavelnth = models.BigIntegerField(verbose_name = 'WAVELNTH', help_text='characteristic wavelength observation', blank=True, null=True, db_index=True)
