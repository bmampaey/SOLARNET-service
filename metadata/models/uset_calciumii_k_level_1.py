...
class UsetCalciumiiKLevel1(BaseMetadata):
	...
	waveban = models.TextField(verbose_name = 'WAVEBAN', help_text='', blank=True, null=True)
	wavelnth = models.FloatField(verbose_name = 'WAVELNTH', help_text='characteristic wavelength of observation', blank=True, null=True)
