...
__all__ = ['UsetCalciumiiKLevel1']


class UsetCalciumiiKLevel1(BaseMetadata):
	"""Model for the metadata of dataset USET CalciumII-K level 1"""

	class Meta(BaseMetadata.Meta):
		verbose_name = 'USET CalciumII-K level 1 metadata'
		verbose_name_plural = 'USET CalciumII-K level 1 metadata'

	bscale = models.BigIntegerField(
		verbose_name='BSCALE', help_text='To be multiplied to the data array values', blank=True, null=True
	)
	btype = models.TextField(
		verbose_name='BTYPE', help_text='type of data, Unified Content Descriptor', blank=True, null=True
	)
	bunit = models.TextField(verbose_name='BUNIT', help_text='unit of physical value', blank=True, null=True)
	bzero = models.BigIntegerField(
		verbose_name='BZERO', help_text='To be added by the data array values', blank=True, null=True
	)
	...
	contact = models.TextField(
		verbose_name='CONTACT', help_text='Contact person at the institution', blank=True, null=True
	)
	creator = models.TextField(
		verbose_name='CREATOR', help_text='Name of software that produced the FITS', blank=True, null=True
	)
	...
	crval1 = models.BigIntegerField(
		verbose_name='CRVAL1', help_text='value of reference pixel along axis 1', blank=True, null=True
	)
	crval2 = models.BigIntegerField(
		verbose_name='CRVAL2', help_text='value of reference pixel along axis 2', blank=True, null=True
	)
	ctype1 = models.TextField(
		verbose_name='CTYPE1', help_text='Helioproj. westward angle, TAN projection', blank=True, null=True
	)
	ctype2 = models.TextField(
		verbose_name='CTYPE2', help_text='Helioproj. northward angle, TAN projection', blank=True, null=True
	)
	...
	obs_mode = models.TextField(
		verbose_name='OBS_MODE', help_text='Predefined settings used during obs.', blank=True, null=True
	)
	obsgeo_x = models.BigIntegerField(
		verbose_name='OBSGEO-X', help_text='ECEF X coord of the observer', blank=True, null=True
	)
	obsgeo_y = models.BigIntegerField(
		verbose_name='OBSGEO-Y', help_text='ECEF Y coord of the observer', blank=True, null=True
	)
	obsgeo_z = models.BigIntegerField(
		verbose_name='OBSGEO-Z', help_text='ECEF Z coord of the observer', blank=True, null=True
	)
	...
	physpara = models.TextField(
		verbose_name='PHYSPARA', help_text='Physical parameter represented in the data', blank=True, null=True
	)
	...
	solar_p0 = models.FloatField(
		verbose_name='SOLAR_P0', help_text='celestial North to solar North angle', blank=True, null=True
	)
	...
	waveunit = models.BigIntegerField(
		verbose_name='WAVEUNIT', help_text='Power of 10 by which the metre is multiplied', blank=True, null=True
	)
