...
class EitSynoptic(BaseMetadata):
	...
	bib_reference = models.TextField(verbose_name = 'bib_reference', help_text='Bibcode or doi preferred; can be URL or anything else', blank=True, null=True)
	...
	map_projection = models.TextField(verbose_name = 'map_projection', help_text='ID from enumerated list, or string with parameters (referring to a standard)', blank=True, null=True)
	...
	messenger = models.TextField(verbose_name = 'messenger', help_text='Electro-magnetic band, from enumerated list', blank=True, null=True)
	...
	producer_institute = models.TextField(verbose_name = 'producer_institute', help_text='Data producer institute', blank=True, null=True)
