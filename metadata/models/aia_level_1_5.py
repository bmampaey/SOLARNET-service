...
class AiaLevel15(BaseMetadata):
	...
	acs_cgt = models.TextField(
		verbose_name='ACS_CGT', help_text='ACS ID of Controlling Guide Telescope', blank=True, null=True
	)
	...
	asd_rec = models.TextField(
		verbose_name='ASD_REC', help_text='Ancillary Science Data series record', blank=True, null=True
	)
	...
	crpix1 = models.FloatField(
		verbose_name='CRPIX1', help_text='CRPIX1: location of sun center in CCD x', blank=True, null=True
	)
	crpix2 = models.FloatField(
		verbose_name='CRPIX2', help_text='CRPIX2: location of sun center in CCD y', blank=True, null=True
	)
	...
	date_obs = models.DateTimeField(
		verbose_name='DATE-OBS', help_text='Date when observation started; ISO 8', blank=True, null=True
	)
	...
	dsun_ref = models.FloatField(
		verbose_name='DSUN_REF', help_text='Reference distance to Sun: 149,597,870,691.', blank=True, null=True
	)
	...
	gcount = models.BigIntegerField(
		verbose_name='GCOUNT', help_text='one data group (required keyword)', blank=True, null=True
	)
	...
	inst_rot = models.FloatField(
		verbose_name='INST_ROT', help_text='Master pointing CCD rotation wrt SDO Z ax', blank=True, null=True
	)
	instrume = models.TextField(
		verbose_name='INSTRUME', help_text='For AIA: AIA_ATA1, AIA_ATA2, AIA_ATA3 or AIA_AT', blank=True, null=True
	)
	...
	isppktim = models.DateTimeField(
		verbose_name='ISPPKTIM', help_text='PACKET_TIME, Prime key value for the', blank=True, null=True
	)
	...
	mpo_rec = models.TextField(
		verbose_name='MPO_REC', help_text='Master Pointing series record point', blank=True, null=True
	)
	...
	naxis1 = models.BigIntegerField(
		verbose_name='NAXIS1', help_text='length of original image axis', blank=True, null=True
	)
	naxis2 = models.BigIntegerField(
		verbose_name='NAXIS2', help_text='length of original image axis', blank=True, null=True
	)
	...
	r_sun = models.FloatField(
		verbose_name='R_SUN', help_text='Radius of the Sun in pixels on the CCD', blank=True, null=True
	)
	...
	rsun_ref = models.FloatField(
		verbose_name='RSUN_REF', help_text='Reference radius of the Sun: 696,000,000.0', blank=True, null=True
	)
	...
	sat_y0 = models.FloatField(
		verbose_name='SAT_Y0', help_text='Position of solar center wrt the SDO', blank=True, null=True
	)
	sat_z0 = models.FloatField(
		verbose_name='SAT_Z0', help_text='Position of solar center wrt the SDO Z', blank=True, null=True
	)
	...
	trecepoc = models.TextField(
		verbose_name='TRECEPOC', help_text='Reference epoch for T_OBS {T_REC', blank=True, null=True
	)
	trecstep = models.FloatField(
		verbose_name='TRECSTEP', help_text='JPS: provide a comment {T_REC_step}', blank=True, null=True
	)
	...
	wavelnth = models.BigIntegerField(
		verbose_name='WAVELNTH', help_text='Wavelength', blank=True, null=True, db_index=True
	)
	...
	x0_mp = models.FloatField(
		verbose_name='X0_MP', help_text='Master pointing X0 sun center in CCD fr', blank=True, null=True
	)
	y0_mp = models.FloatField(
		verbose_name='Y0_MP', help_text='Master pointing Y0 sun center in CCD fr', blank=True, null=True
	)
