...
class Rosa(BaseMetadata):
	...
	date = models.TextField(
		verbose_name='DATE', help_text='Creation UTC (CCCC-MM-DD) date of FITS header', blank=True, null=True
	)
	extend = models.BigIntegerField(
		verbose_name='EXTEND', help_text='FITS data may contain extensions', blank=True, null=True
	)
