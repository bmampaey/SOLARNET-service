...
class Keyword(models.Model):
	...
	name = models.CharField(
		max_length=200,
		help_text='Name of the corresponding field in the metadata model, can contain only letters, digits and underscore',
		validators=[valid_keyword_name],
	)
	verbose_name = models.CharField(
		max_length=200, help_text='Verbose name of the keyword, can contain any unicode character'
	)
	type = models.CharField(
		max_length=KeywordType.max_length(),
		default=KeywordType.TEXT,
		choices=KeywordType.choices,
		help_text='Python type of the keyword',
	)
