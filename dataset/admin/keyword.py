...
class KeywordAdmin(admin.ModelAdmin):
	...
	def get_queryset(self, request):
		# Display only the keywords of the datasets for which the user has access to
	...
	def has_change_permission(self, request, obj=None):
		...
		# Allow the user to only change a keyword if he is a user of that dataset's user_group
